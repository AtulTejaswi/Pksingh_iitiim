  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      <div className="text-center mb-16">
          <span className="inline-block px-3 py-1 rounded-full bg-amber-100 border border-amber-200 text-amber-800 text-xs font-bold uppercase tracking-[0.2em] mb-4">
          Why Mentorship?
        </span>
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
          The <span className="text-amber-600">1-on-1</span> Advantage
        </h2>
      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 rounded-3xl overflow-hidden shadow-2xl border border-slate-200 bg-white">
          ...
          <div className="p-8 bg-slate-900 text-white relative shadow-[inset_0_0_40px_rgba(0,0,0,0.2)]">
            ...
            <div className="space-y-6 md:space-y-12 relative z-10">
              ...
              <div className="flex flex-col md:block h-auto md:h-10 justify-center">
                <span className="md:hidden text-xs font-semibold text-amber-200 uppercase mb-1">Doubt Resolution</span>
              ...
              <div className="flex flex-col md:block h-auto md:h-10 justify-center">
                <span className="md:hidden text-xs font-semibold text-amber-200 uppercase mb-1">Study Strategy</span>
              ...
              <div className="flex flex-col md:block h-auto md:h-10 justify-center">
                <span className="md:hidden text-xs font-semibold text-amber-200 uppercase mb-1">Accountability</span>
              ...
              <div className="flex flex-col md:block h-auto md:h-10 justify-center">
                <span className="md:hidden text-xs font-semibold text-amber-200 uppercase mb-1">Exam Analysis</span>
