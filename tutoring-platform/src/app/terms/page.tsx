  ...
  return (
    <PublicPageShell>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 text-slate-600 text-sm leading-relaxed space-y-4">
        ...
        <h2 className="text-lg font-semibold text-slate-900 pt-4">Educational content</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-900 pt-4">Accounts</h2>
        <p>
          You are responsible for keeping your login credentials secure. Notify us immediately if you suspect
          unauthorized access to your account.
        </p>
        <h2 className="text-lg font-semibold text-slate-900 pt-4">Disclaimer</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-900 pt-4">Support</h2>
        <p>
          For help, see the{' '}
