  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 space-y-10">
      ...
      <section>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row gap-6 items-center hover:shadow-md transition-shadow">
          <div className="h-32 w-full md:w-56 bg-gray-100 rounded-xl flex-shrink-0 border border-gray-200 overflow-hidden relative group">
            {/* Mock Thumbnail */}
          ...
          <div className="flex-1 w-full">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-500 font-medium">Chapter 4: Work & Energy</span>
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">Complete Physics Masterclass</h3>
            
            {/* Progress Bar */}
            <div className="mt-6">
              <div className="flex justify-between text-sm font-medium mb-1.5">
                <span className="text-gray-700">65% Completed</span>
                <span className="text-gray-500">12/18 Lessons</span>
              </div>
          ...
          <div className="w-full md:w-auto mt-4 md:mt-0">
            <Link href="/learn/course-123/lesson-456" className="w-full md:w-auto inline-flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded-xl font-medium transition-colors">
              Resume Lesson
...
function CourseCard({ title, progress, tag }: { title: string, progress: number, tag: string }) {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-lg transition-all group cursor-pointer flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        <h3 className="font-bold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors line-clamp-2">{title}</h3>
