...
import { ArrowLeft, Save, Sparkles, BookOpenCheck, AlertTriangle } from 'lucide-react';
...
export default function NewCoursePage() {
  ...
  const {
    ...
    defaultValues: {
      isFree: true, // Default to free course as per requirements
      examTags: [],
    },
  });
    ...
    <div className="w-full text-left">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-white tracking-tight flex items-center gap-2">
          <Sparkles className="w-7 h-7 text-indigo-400" /> Create New Course
        </h1>
        <p className="text-gray-400 text-sm mt-1">Configure subjects, price classifications, and syllabus metadata.</p>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Provide a comprehensive summary of this course's syllabus details, required prerequisites, and learning objectives..."
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                <option value="" disabled className="bg-[#0b0f19]">Select Subject</option>
                {SUBJECTS.map((sub) => (
          ...
          >
            {isPending ? (
              ...
              <>
                <Save className="w-4 h-4" /> Save & Create Course
              </>
            )}
          </button>
        </form>
